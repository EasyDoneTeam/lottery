...
contract ERC20 is Ownable {
    ...
    constructor (string tokenName, string tokenSymbol, address _dev1, address _dev2, address _dev3, address _dev4) public {
        totalSupply = 100000e18;
        name = tokenName;
        symbol = tokenSymbol;
        owner = msg.sender;
        uint256 dev_amount = 15000e18;
        balanceOf[_dev1] = dev_amount;
        balanceOf[_dev2] = dev_amount;
        balanceOf[_dev3] = dev_amount;
        balanceOf[_dev4] = dev_amount;
